...
```
*디컴파일 명령어*
java -jar apktool_2.12.1.jar d "디컴파일할 APK" 

*리패키징 명령어*
java -jar apktool_2.12.1.jar b "리패키징할 파일"    (앱 이름은 왠만하면 영어로)
```
...
*리패키징한 APK를 내 키로 서명
cd C:\Users\woght\AppData\Local\Android\Sdk\build-tools\36.0.0
apksigner sign --ks "C:\Program Files\Java\jdk-22\bin\my.keystore" --ks-key-alias mykey --ks-pass pass:rlawogh123. --key-pass pass:rlawogh123. --v1-signing-enabled false --v2-signing-enabled true --v3-signing-enabled false --out "C:\Users\woght\AppData\Local\Android\Sdk\build-tools\36.0.0\outback_signOK.apk" "C:\Users\woght\AppData\Local\Android\Sdk\build-tools\36.0.0\outback_repack.apk"

apksigner sign 
 --ks "C:\Program Files\Java\jdk-22\bin\my.keystore"      // 사용할 키스토어 파일
 --ks-key-alias mykey                                     // 키스토어 안에서 사용할 alias
 --ks-pass pass:rlawogh123.                               // 키스토어 비밀번호
 --key-pass pass:rlawogh123.                              // 해당 alias 비밀번호
 --v1-signing-enabled false                               // v1서명
 --v2-signing-enabled true                                // v2서명
 --v3-signing-enabled false                               // v3서명
 --out "C:\Users\woght\AppData\Local\Android\Sdk\build-tools\36.0.0\outback_signOK.apk"    // 서명 완료된 결과APK
 "C:\Users\woght\AppData\Local\Android\Sdk\build-tools\36.0.0\outback_repack.apk"          // 서명할 대상(리패키징된APK)
