...
<img src="/assets/images/icon/패키지명.png" style="max-width:100%;"><br>
ㄴ권한 : 앱에서 필요한 권한은 uses-permission요소 사용하여 명시, 사용자에게 허용 요청하여 승인하면 기능 사용<br>
<img src="/assets/images/icon/uses-permission.png" style="max-width:100%;"><br>
