...
즉, 안드로이드에서 화면내용을 외부로 못 빼가게 막는 보안 플래그<br>
<br>
@override<br>
protected void onResume(){           
    super.onResume();               // 액티비티 포그라운드로 올라올 때<br>
<br>
    // FLAG_SECURE 플래그 제거 (화면 캡처, 녹화, 미리보기 허용함) <br>
    getWindow().clearFlags(WindowManager.LayoutParams.FLAG_SECURE);  <br>
}<br>
@override<br>
protected void onPause(){<br>
    super.onPause();                // 액티비티 백그라운드로 전환될 때 호출<br>
<br>
    // FLAG_SECURE 플래그 설정 (화면 캡처, 녹화, 미리보기 차단함) <br>
    getWindow().addFlags(WindowManager.LayoutParams.FLAG_SECURE); <br>
}<br>
<br>
<br>
❌ FLAG_SECURE만 쓰면<br>
